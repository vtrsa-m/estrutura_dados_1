...
void executa(int opcao, struct ListaEnc **lista )
{
    char chave[40];
    struct Estudante e;
    int n; // Variável auxiliar para o caso 10
    switch (opcao)
    {
        case 1: 
        ...
        case 9:
            ...
            break;
        case 10:
            printf("Informe a chave de busca (Nome ou ID): ");
            getchar(); 
            scanf("%[^\n]", chave);
            
            printf("Quantidade de elementos anteriores a imprimir: ");
            scanf("%d", &n);
